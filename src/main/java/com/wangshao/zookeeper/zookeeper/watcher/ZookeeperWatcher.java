package com.wangshao.zookeeper.zookeeper.watcher;
...
public class ZookeeperWatcher implements Watcher {
    ...
    //zookeeper服务器地址
    private static final String CONNECTION_ADDR =  "192.168.1.10:2181,192.168.1.11:2181,192.168.1.12:2181";
    //父路径设置
    ...
    //等待zookeeper连接建立之后,通知阻塞程序继续向下执行
    private CountDownLatch countDownLatch = new CountDownLatch(1);

    /**
     * 创建zk连接
     * @param connectAddr zk服务器列表
    ...
    public void process(WatchedEvent event) {
        ...
        if (Event.KeeperState.SyncConnected == keeperState) {
            ...
            System.out.println(logPrefix + "绘画失效");
        }
        else;
        System.out.println("------------------------------------------------------");
    }
